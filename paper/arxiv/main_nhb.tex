...
lexical and topical content even when the local ordering of that content is disrupted. Hilberg's
conjecture, a reinterpretation of Shannon's guessing experiments \citep{shannon1951prediction},
holds that the conditional entropy of text falls as a power law of context length
\citep{hilberg1990grenzwert, debowski2015relaxed}; it likewise concerns total predictive
information, conflating the contribution of word identities with that of their arrangement. But
language carries additional structure that these measures do not capture: the order in which
