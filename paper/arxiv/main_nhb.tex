...
\begin{abstract}
\noindent
Human language exhibits well-established scaling laws for vocabulary growth, word frequency, and syntactic
...
domain-native models. An exponent near $1$ distributes contextual influence approximately
uniformly across logarithmic timescales. These results establish a previously undescribed
scaling law of contextual persistence --- a constraint any theory of language must
explain.
\end{abstract}
