...
establish a scaling law of contextual persistence --- a constraint any theory of language must
explain.
\end{abstract}
...
the units not singly but in pairs: how their occurrences co-vary across distance. The mutual information
...
floor reached within the measured range. Our intact-context measurement is the same program,
carried out with a probe over far longer contexts. But in this tradition order itself was never a
variable: context was always presented intact and only its length was varied, so the resulting
curve is a total, mixing what is gained from the words revealed with what is gained from their
arrangement, with no way to tell the two apart. At
