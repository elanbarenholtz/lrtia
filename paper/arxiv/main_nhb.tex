...
conjecture, which holds that the conditional entropy of text falls as a power law of context
length \citep{hilberg1990grenzwert, debowski2015relaxed}, concerns total predictive information,
and likewise conflates the contribution of word identities with that of their arrangement.) But language
...
approximate it only crudely. Large autoregressive transformer models
\citep{vaswani2017attention, radford2019language} provide a tool for capturing exactly this
structure: trained only to predict the next token, they assign token-level conditional
...
context is revealed. The sequence itself supplies the axis of measurement: revealing the true
...
and co-occurrence are removed. We view it
as a law to be explained rather than as an adjudication between mechanisms: any account of how
