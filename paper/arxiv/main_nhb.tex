...
lexical and topical content even when the local ordering of that content is disrupted. The same
limitation holds for Hilberg's conjecture, a reinterpretation of Shannon's guessing experiments
\citep{shannon1951prediction}, which posits that the conditional entropy of text falls as a power
law of context length \citep{hilberg1990grenzwert, debowski2015relaxed}: although the quantity is
conditioned on preceding text, it tracks total predictive information, in which the contribution
of word identities and that of their arrangement are combined and cannot be separated. But
language carries additional structure that none of these measures isolates: the order in which
units appear. Word order
carries what neither lower level can register. Those levels record which words are present and at
what distances they co-occur; but the same words at the same separations can compose entirely
different meanings depending on their arrangement. Grammatical relations and compositional meaning
live in arrangement itself, not in the inventory of words or their spacing. Representational accounts of
