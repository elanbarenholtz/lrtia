...
with a probe reaching far longer contexts. But extension alone cannot answer the question posed
above, because in this tradition order was never a variable: context was always presented intact
and only its length was varied, so the resulting curve is a total, mixing what is gained from the
words revealed with what is gained from their arrangement, with no way to tell the two apart. At
