...
The exponent itself invites comparison beyond language: model-free measurements of human
memory --- the environmental statistics of information demand, the dynamics of free recall, and
the form of forgetting --- yield power laws in the same order-unity neighborhood, a convergence
...
margin relative to shuffled controls. Long-range contextual influence is not confined to a recency
