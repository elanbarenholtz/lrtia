...
\begin{abstract}
\noindent
Human language exhibits lawful statistical structure at the level of single words (frequency,
vocabulary growth) and of word pairs (co-occurrence across distance); the structure of word order, which carries grammar
and compositional meaning, has remained unmeasured. Using
large language models as probabilistic probes, we measured the reduction in target perplexity
conferred by prior context at distance $d$ beyond that conferred by the same words scrambled;
this difference, the contextual persistence function $P(d)$, isolates the influence of
sequential arrangement. Across ten corpora spanning six language
...
contextual influence approximately uniformly across logarithmic timescales. These results
